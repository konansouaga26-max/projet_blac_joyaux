<header id="site-header" class="sticky top-0 z-40 bg-bj-creme border-b border-bj-sable transition-transform duration-300">
    <nav class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <ul class="hidden md:flex items-center gap-8 text-sm font-medium uppercase tracking-wide text-bj-noir">
        ...
        <div class="flex items-center gap-4 text-bj-cuir">
            <button aria-label="Notifications" class="hover:text-bj-violet transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" />
                </svg>
            </button>
            <button aria-label="Rechercher" class="hover:text-bj-violet transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                </svg>
            </button>
            <a href="{{ url('/compte') }}" class="hidden md:inline-block hover:text-bj-violet transition-colors" aria-label="Mon compte">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.5 20.25a8.25 8.25 0 0115 0" />
                </svg>
            </a>
            <a href="{{ url('/panier') }}" class="hidden md:inline-flex relative hover:text-bj-violet transition-colors" aria-label="Mon panier">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
