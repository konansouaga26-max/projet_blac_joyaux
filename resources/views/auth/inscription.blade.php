...
<section class="max-w-md mx-auto px-4 py-14">
    ...
    <form method="POST" action="{{ route('register.post') }}" class="space-y-4 bg-white rounded-sm shadow-sm p-6">
        ...
        <div>
            ...
            <div class="flex">
                <span
                    class="flex items-center px-3 border border-r-0 border-bj-noir/20 rounded-l-sm bg-bj-sable text-sm">+225</span>
        ...
        <div>
            ...
            <div class="relative">
                <input type="password" name="password_confirmation" id="password_confirmation" required minlength="8"
                    class="w-full border border-bj-noir/20 rounded-sm px-4 py-3 pr-11 text-sm focus:outline-none focus:border-bj-or">
                <button type="button" onclick="basculerMdp('password_confirmation', this)"
